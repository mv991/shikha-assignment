...
const Card = ({show,handleClick,buttonText}:props) => {
  ...
  return (
    <div onClick={() => addToWish()} className='w-fit flex h-[300px] shadow-md gap-6 pr-3 '> 
    ...
    <button className='bg-black px-6 py-2 text-white rounded-md mt-2 mb-4 w-full' disabled={loading}>{loading?"Loading...":buttonText}</button>
